  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-lg font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        alarm: "bg-alarm text-alarm-foreground hover:bg-alarm/90 shadow-xl shadow-alarm/30 text-xl",
        alarmSecondary: "bg-alarm-foreground/20 text-alarm-foreground border-2 border-alarm-foreground/30 hover:bg-alarm-foreground/30",
      },
      size: {
